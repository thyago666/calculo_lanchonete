...
return view('viewLanches',compact('ingredientes','lanches','psq','acessorios','valorMarkup','valorMarkupIfood','valorMarkupIqfome','parametros'));
         ...
         $total_acessorio = ($total_acessorio+$acessorio->valor*$acessorio->qtd_itens);
          ...
          if($psq != null){
            ...
            if($item){
              ...
              if($produto->valor_atual != $valor_lucro){
                $produto->valor_anterior = $produto->valor_atual;
                $produto->valor_atual = $valor_lucro;
                $produto->save();
                $valor_atual = $valor_lucro;
              ...
              $dados = new Atualiza([
                ...
                $produto=Atualiza::find($dados->id);
                $valor_atual = $valor_lucro;
                $valor_anterior = $produto->valor_anterior;
                $produto->save();
                $dados_historico = historico::where('id_produto',$id_produto)->get();
          ...
          return view('viewHistoricoProdutos',compact('lanches','psq','valor_atual','valor_anterior','dados_historico'));
      }
