...
<div class="container">
    ...
    <div class="form-group">
     ...
     <div class="form-group">
        ...
        <select class="form-control" id="fritadeira" name="fritadeira">
...
<div class="container">
    ...
    <div class="form-group">
        <label for="unidade_medida"><b>Ingredientes</b></label>
        <select class="form-control" id="ingredientes" name="ingredientes" onchange="showFritadeira(this.value)">
            @foreach($ingredientes as $ingrediente)
          <option value={{$ingrediente->id}}>{{$ingrediente->descricao}} - {{$ingrediente->unidMedida}}</option>
          @endforeach
           </select>
     ...
     <div class="form-group" id="fritadeiraDiv" style="display: none;">
      ...
      <div class="form-group" id="qtdOleoFritadeira">
        <label for="descricao"><b>Qtd de Óleo</b></label>
        <input type="number" class="form-control" id="qtdOleoFritadeira" name="qtdOleoFritadeira">
      ...
      <div class="form-group" id="qtdPorcaoFritadeira">
        <label for="descricao"><b>Qtd de Porção</b></label>
        <input type="number" class="form-control" id="qtdPorcaoFritadeira" name="qtdPorcaoFritadeira">
